...
const isRedBlueEqual = compose(({ red, blue }) => red === blue, numberOfColors);

const atLeastTwoGreen = compose(({ green = 0 }) => green >= 2, numberOfColors);

const onlyTwoGreen = compose(({ green = 0 }) => green === 2, numberOfColors);

const onlyOneRed = compose(({ red = 0 }) => red === 1, numberOfColors);
